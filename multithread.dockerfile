...
#
# Build:
#   docker build -f Dockerfile.multithread -t qt-wasm-builder:6.11.1-mt .
#
# Run (mount your project at /app):
#   docker run --rm -v $(pwd):/app qt-wasm-builder:6.11.1-mt \
